...
const Signin = () => {
  ...
  const SigninSchema = Yup.object().shape({
    ...
    password: Yup.string()
      .min(6, t("formErrors.2"))
      .required(t("formErrors.3")),
    keepMeSignedIn: Yup.boolean().oneOf([true], t("formErrors.4")),
  });
        ...
        >
          ...
          <div className="flex flex-wrap gap-4">
            <button
              ...
              className="border-stroke text-body-color dark:text-body-color-dark hover:border-primary hover:bg-primary/5 hover:text-primary dark:hover:border-primary dark:hover:bg-primary/5 dark:hover:text-primary mb-4 flex w-[48%] items-center justify-center gap-3 rounded-xs border bg-[#f8f8f8] px-6 py-3 text-base transition-all duration-300 max-sm:w-full dark:border-transparent dark:bg-[#2C303B]"
            >
              <svg
                width="20"
                height="20"
                ...
                <div className="mb-7.5 flex flex-col gap-7.5 lg:mb-12.5 lg:flex-row lg:justify-between lg:gap-14">
                  <div className="w-full lg:w-1/2">
                    <Field
                      ...
                      className="border-stroke focus:border-waterloo dark:border-strokedark dark:focus:border-manatee w-full border-b bg-white! pb-3.5 focus:placeholder:text-black focus-visible:outline-hidden dark:bg-black! dark:focus:placeholder:text-white"
                    />
                    <ErrorMessage
                      name="email"
                      component="div"
                ...
                <div className="flex flex-wrap items-center gap-10 md:justify-between xl:gap-15">
                  <div className="flex flex-wrap gap-4 md:gap-10">
                    {/* <div className="mb-4 flex items-center">
                      ...
                      />
                      <span
                        className={`group mt-1 flex h-5 min-w-[20px] items-center justify-center rounded-sm border ${
                          errors.keepMeSignedIn && touched.keepMeSignedIn
                            ? "border-red-500"
                            : "border-gray-300"
                        } peer-checked:bg-primary bg-gray-100 text-white dark:border-gray-600 dark:bg-gray-700`}
                      >
                  ...
                  >
                    {isSubmitting ? t("buttons.6") : t("buttons.0")}
                  </button>
                </div>
