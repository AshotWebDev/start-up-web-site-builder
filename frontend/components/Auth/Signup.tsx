...
const Signup = () => {
  ...
  firstName: Yup.string()
    .required(t("formErrors.5")),
  lastName: Yup.string()
    .required(t("formErrors.6")),
  ...
  const handleSubmit = (values: any) => {
    ...
    const { firstName, lastName, email, password, keepSignedIn } = values;
    const userData = {
          ...
          >
            {({ values, setFieldValue }) => (
              <Form>
                <div className="mb-7.5 flex flex-col gap-7.5 lg:mb-12.5 lg:flex-row lg:justify-between lg:gap-14">
                  <div className="w-full lg:w-1/2">
                    <Field
                      ...
                      className="border-stroke focus:border-waterloo dark:border-strokedark dark:focus:border-manatee w-full border-b bg-transparent pb-3.5 focus-visible:outline-hidden"
                    />
                    <ErrorMessage
                      name="firstName"
                      component="div"
                ...
                <div className="flex flex-wrap gap-10 md:justify-end xl:gap-15">
                  {/* <div className="mb-4 flex items-center">
                    ...
                    <label htmlFor="keepSignedIn" className="flex max-w-[425px] cursor-pointer select-none pl-3">
                      Keep me signed in
                    </label>
                  </div> */}
