...
const About = () => {
  ...
  const features = [
    {
      id: 1,
      title: t("HomePage.aboutSection.features.0"),
    },
    {
      id: 2,
      title: t("HomePage.aboutSection.features.1"),
    },
    {
      id: 3,
      title: t("HomePage.aboutSection.features.2"),
    },
  ];
      ...
      <section className="overflow-hidden pb-20 lg:pb-25 xl:pb-30">
        <div className="max-w-c-1235 mx-auto px-4 md:px-8 xl:px-0">
          <div className="flex items-center gap-8 lg:gap-32.5">
            ...
            >
              <Image
                src="/images/about/aboutSectionImg.png"
                alt={t("HomePage.aboutSection.illustrationText")}
            ...
            >
              ...
              <p>{t("HomePage.aboutSection.description")}</p>

              {features.map((feature) => (
                <div className="mt-7.5 flex items-center gap-5" key={feature.id}>
